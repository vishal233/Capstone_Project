...
<div class="page-container row"> 
  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <div class="page-title"> <button onclick="history.back()" style="border: none; background-color: rgba(255,255,255,0);"><i class="icon-custom-left"></i></button>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Table <span class="semi-bold">Logs</span></h4>
